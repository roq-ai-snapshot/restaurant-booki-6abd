...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'menu.create': { roles: ['owner'], key: 'new-menu-created', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'menu.update': { roles: ['owner'], key: 'menu-updated', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'reservation.create': {
    roles: ['owner', 'chef'],
    key: 'new-reservation',
  ...
  'table.create': { roles: ['chef'], key: 'table-created', tenantPath: ['restaurant', 'table'], userPath: [] },
  'table.update': { roles: ['chef'], key: 'table-updated', tenantPath: ['restaurant', 'table'], userPath: [] },
};
